...
PYTHONPATH=. \
python3 -u ./thumt/bin/trainer.py \
  --input ../125w-zip/train.zh.32k.shuf.partB ../125w-zip//train.en.32k.shuf.partB \
  ...
  --output ../output/base_75w_b \
  --parameters=batch_size=16384,device_list=[0,1,2,3,4,5,6,7],update_cycle=2,keep_top_checkpoint_max=1,eval_steps=500 \
  --hparam_set bases \
